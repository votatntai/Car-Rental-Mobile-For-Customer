                              ...
                              child: Row(
                                ...
                                children: [
                                  VerticalIcon(
                                    ...
                                    label:
                                        '${successState.car.model.seater} chỗ',
                                  ),
                                  VerticalIcon(
                                    icon: Icons.memory_outlined,
                                    label:
                                        successState.car.model.transmissionType,
                                  ),
                                  VerticalIcon(
                                ...
                                onPressed: () {
                                  if (isLicenseValid == false &&
                                    ...
                                    showMessageDialog(
                                      title: 'Thông báo',
                                      message:
                                          'Bạn phải cập nhật thông tin lái xe để đặt xe',
                                    );
                                  } else {
                                    context.pushNamed(
