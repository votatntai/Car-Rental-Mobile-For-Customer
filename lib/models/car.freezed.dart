...
class _$_Car implements _Car {
  ...
  @override
  String toString() {
    return 'Car(id: $id, name: $name, imageUrl: $imageUrl, description: $description, price: $price, brand: $brand)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, name, imageUrl, description, price, brand);
...
abstract class _Car implements Car {
  const factory _Car(
      ...
      required final String brand}) = _$_Car;
