...
abstract class $WalletCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, double balance, String status});
}
...
class _$_Wallet implements _Wallet {
  const _$_Wallet(
      {required this.id, required this.balance, required this.status});
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, balance, status);
...
abstract class _Wallet implements Wallet {
  const factory _Wallet(
      ...
      required final String status}) = _$_Wallet;
