...
abstract class $DriverCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {String id, String name, String? address, String phone, String gender});
}
...
class _$_Driver implements _Driver {
  ...
  @override
  String toString() {
    return 'Driver(id: $id, name: $name, address: $address, phone: $phone, gender: $gender)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, name, address, phone, gender);
...
abstract class _Driver implements Driver {
  const factory _Driver(
      ...
      required final String gender}) = _$_Driver;
